...
package org.fenixedu.academic.utils;
...
public class ParseMetadata extends DefaultHandler {
    ...
    private Metadata vector2Metadata(Vector<Element> vector, Metadata metadata) {
        boolean difficulty = false, description = false, mainsubject = false, secondarysubject = false, level = false, author =
                false, value = false, typicallearningtime = false;
